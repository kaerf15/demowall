...
INSERT INTO "new_Product" ("createdAt", "description", "detail", "favorites", "githubUrl", "id", "imageUrl", "likes", "makerAvatar", "makerEmail", "makerName", "name", "published", "twitterUrl", "updatedAt", "userId", "websiteUrl") SELECT "createdAt", "description", "detail", "favorites", "githubUrl", "id", "imageUrl", "likes", "makerAvatar", "makerEmail", "makerName", "name", "published", "twitterUrl", "updatedAt", "userId", "websiteUrl" FROM "Product";
DROP TABLE "Product";
